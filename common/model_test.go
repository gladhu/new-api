...
func TestIsBedrockOpenAIModel(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "gpt-6-astra-pro", want: true},
		{model: "openai.gpt-6-astra", want: true},
		{model: "global.openai.gpt-6-astra", want: true},
		{model: "us.gpt-6-astra", want: true},
		{model: "gpt-7-foo", want: true},
		...
		{model: "gpt-5.3-codex", want: false},
